...
#define _FILE_OFFSET_BITS 64  //(line4)#define _FILE_OFFSET_BITS 64
#define _THREAD_SAFE
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
int
//make_bfs_tree (int64_t *bfs_tree_out, int64_t *max_vtx_out, int64_t srcvtx)
make_bfs_tree (int64_t *bfs_tree_out, int64_t *max_vtx_out, int64_t srcvtx)
{
  int64_t * restrict bfs_tree = bfs_tree_out;//int64_t * restrict bfs_tree = bfs_tree_out;
  int err = 0;
  const int64_t nv = maxvtx+1;//const int64_t nv = maxvtx+1;

  int64_t k, k1, k2;  //int64_t k, k1, k2;
  int64_t * restrict vlist;  //int64_t * restrict vlist;
