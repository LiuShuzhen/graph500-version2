...
//return (p->v0_low | ((int64_t)((int16_t)(p->high & 0xFFFF)) << 32));
  return (p->v0_low | ((int32_t)((int16_t)(p->high & 0xFFFF)) << 32));
}
...
//return (p->v1_low | ((int64_t)((int16_t)(p->high >> 16)) << 32));
  return (p->v1_low | ((int32_t)((int16_t)(p->high >> 16)) << 32));
}
...
static inline void write_edge(packed_edge* p, int32_t v0, int32_t v1) {
  ...
  printf("%d %d %d\n", p->v0_low, p->v1_low, p->high);
}

#else

typedef struct packed_edge {
  int32_t v0;   //int64_t v0; 
  int32_t v1;   //int64_t v1; 
} packed_edge;
//static inline int64_t get_v0_from_edge(const packed_edge* p)
static inline int32_t get_v0_from_edge(const packed_edge* p) {
  return p->v0;
...
void generate_kronecker_range(
       ...
       int logN /* In base 2 */,
       int32_t start_edge, int32_t end_edge , // int64_t start_edge, int64_t end_edge              /*Indices (in [0, M)) for the edges to generate */,
